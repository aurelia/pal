...
*/
export var FEATURE = {}; // HACK: `FEATURE` actually gets initialized during bootstrap but for all practical purposes we consider it as `Feature`.
/**
...
*/
export var DOM = {}; // HACK: `DOM` actually gets initialized during bootstrap but for all practical purposes we consider it as `Dom`.
